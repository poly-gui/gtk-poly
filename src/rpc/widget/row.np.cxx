...
Rpc::Row::Row(std::optional<uint32_t> tag, double width, double height,
...
size_t Rpc::Row::read_from(NanoPack::Reader &reader) {
...
NanoPack::TypeId Rpc::Row::type_id() const { return TYPE_ID; }

size_t Rpc::Row::header_size() const { return 28; }

size_t Rpc::Row::write_to(NanoPack::Writer &writer, int offset) const {
